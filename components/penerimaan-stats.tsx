...
export function PenerimaanStats({ selectedYear }: { selectedYear: string }) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      toast.error('Gagal memuat data statistik penerimaan');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-8 fade-in-up">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm font-medium">Analisis mendalam penerimaan dana ZIS berdasarkan berbagai kategori.</p>
        </div>
